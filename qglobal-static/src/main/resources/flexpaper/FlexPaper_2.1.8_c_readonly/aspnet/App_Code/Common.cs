...
namespace lib
{
    public static class Common
    {
        ...
        {
            return doc!=null  && !(doc.Length > 255 || page!=null && page.Length > 255) && doc.IndexOf('\\') == -1 && doc.IndexOf('/') == -1 && page.IndexOf('\\') == -1 && page.IndexOf('/') == -1  && (doc + page).IndexOf("..") == -1 && (doc + page).IndexOf("cmd.") == -1 && (doc + page).IndexOf(".exe") == -1;
        }
